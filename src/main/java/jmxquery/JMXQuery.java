...
public class JMXQuery {
    ...
    private void report(CompositeDataSupport data, PrintStream out) {
        ...
        out.print(",");
        for (final Iterator<String> it = type.keySet().iterator(); it.hasNext(); ) {
    ...
    private void execute() throws Exception {
        ...
        if (infoAttribute != null) {
            ...
            if (infoKey != null && (infoValue instanceof CompositeDataSupport) && verbosity < 4) {
    ...
    private void printHelp(final PrintStream out) {
        final InputStream is = JMXQuery.class.getClassLoader().getResourceAsStream("jmxquery/HELP");
